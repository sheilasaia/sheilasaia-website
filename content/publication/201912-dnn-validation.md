...
publication = "*Journal of Advances in Modeling Earth Systems (in prep and preprint via EarthArxiv)*"
publication_short = "*JAMES (in prep and preprint via EarthArxiv)*"
